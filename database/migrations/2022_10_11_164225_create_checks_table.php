...
//            $table->integer('invoice_number')->nullable();
            ...
            $table->foreign("client_id", "check_client_fk")->on("client")->references("id")->onDelete('cascade');
            $table->foreign("address_id", "check_address_fk")->on("addresses")->references("id")->onDelete('cascade');
            $table->foreign("contract_client_id", "check_contract_fk")->on("client_contracts")->references("id")->onDelete('cascade');
            ...
            $table->foreign("requisites_client_id", "requisites_currency_fk")->on("client_requisites")->references("id")->onDelete('cascade');
            $table->foreign("requisites_user_id", "requisites_user_check_fk")->on("user_requisites")->references("id")->onDelete('cascade');
