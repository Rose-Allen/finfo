...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="275px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_toggle">
    ...
    <div class="d-flex flex-stack px-4 px-lg-6 py-3 py-lg-8" id="kt_app_sidebar_logo">
        ...
        <a href="{{ route('dashboard.index') }}">
            <img alt="Logo" src="{{ asset('assets/media/logos/demo23.svg') }}" class="h-20px h-lg-25px theme-light-show">
            <img alt="Logo" src="{{ asset('assets/media/logos/demo23-dark.svg') }}" class="h-20px h-lg-25px theme-dark-show">
        </a>
        <!--end::Logo image-->
        <!--begin::User menu-->
        <div class="ms-3">
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <a href="tel:{{ auth()->user()->phone }}" class="fw-semibold text-muted text-hover-primary fs-7">{{ auth()->user()->phone }}</a>
                        </div>
                        <!--end::Username-->
                    </div>
                </div>
    ...
    <div class="flex-column-fluid px-4 px-lg-8 py-4" id="kt_app_sidebar_nav">
        ...
        <div id="kt_app_sidebar_nav_wrapper" class="d-flex flex-column hover-scroll-y pe-4 me-n4" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar, #kt_app_sidebar_nav" data-kt-scroll-offset="5px" style="height: 655px;">
            ...
            <div class="mb-6">
                ...
                <!--end::Title-->
                <!--begin::Row-->
                <div class="row row-cols-2 row-cols-lg-3" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]" data-kt-initialized="1">
                    <!--begin::Col-->
                    <div class="col mb-4">
                        <!--begin::Link-->
                        <a href="{{ route('dashboard.index') }}" class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-90px h-90px border-gray-200" data-kt-button="true">
                            <!--begin::Icon-->
                            <span class="mb-2">
                    ...
                    <div class="col mb-4">
                        <!--begin::Link-->
                        <a href="{{ route('client.index') }}" class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-90px h-90px border-gray-200" data-kt-button="true">
                            <!--begin::Icon-->
                            <span class="mb-2">
